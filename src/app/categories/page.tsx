...
export default function CategoriesPage() {
  ...
  const CategoryNode = ({ category, level = 0 }: { category: {id: string, name: string, description: string, sourceCount: number, defaultPolicy: string, children?: Array<{id: string, name: string, description: string, sourceCount: number, defaultPolicy: string}>}, level?: number }) => {
